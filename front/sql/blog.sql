...
CREATE TABLE IF NOT EXISTS `b_article` (
  ...
  PRIMARY KEY (`a_id`),
  INDEX `fk_b_article_c_id_idx` (`a_categorie` ASC) ,
  INDEX `fk_b_article_1_idx` (`a_author` ASC) ,
  CONSTRAINT `fk_b_article_c_id`
...
CREATE TABLE IF NOT EXISTS `b_comment` (
  ...
  `c_valide` TINYINT UNSIGNED NULL,
